...
function CreateElection() {
  ...
  const handleCreateElection = () => {
    ...
    if (electionStartTime < now) {
      message.error(
        "Election start date and time cannot be earlier than the current date and time"
      );
      return;
    }

    if (electionEndTime <= electionStartTime) {
      message.error("Election end date cannot be earlier than the start date");
      return;
    }
