...
// import Candidates from "./pages/Candidates"; // Import CandidatesPage component
// import UserChoicesChart from "./pages/ResultsPage";
// import ViewCandidates from "./pages/ViewCandidates"; // Import UserChoicesChart component
...
//       <Route
//         path="/voters-login"
//         element={<VotersLogin onLogin={handleLogin} />}
//       />
//       {isLoggedIn && <Route path="/dashboard/*" element={<Dashboard />} />}
//       {isLoggedIn && <Route path="/otp-screen" element={<OTPGenerator />} />}
//       {isLoggedIn && <Route path="/candidates" element={<Candidates />} />}
//       {isLoggedIn && (
